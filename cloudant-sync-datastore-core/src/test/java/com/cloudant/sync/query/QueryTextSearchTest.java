...
public class QueryTextSearchTest extends AbstractQueryTestBase {
    ...
    public void canMakeAQueryConsistingOfASingleTextSearch() {
        assertThat(ds.ensureIndexed(Arrays.<Object>asList("comment"), "basic_text", IndexType.TEXT),
                                    is("basic_text"));
    ...
    public void canMakeAQueryConsistingOfASingleTextSearchWithASort() {
        assertThat(ds.ensureIndexed(Arrays.<Object>asList("name", "comment"), "basic_text", IndexType.TEXT),
                                    is("basic_text"));
        ...
        QueryResult queryResult = ds.find(query, 0, 0, null, sortDocument);
        assertThat(queryResult.documentIds(), containsInAnyOrder("mike12", "fred12"));
    ...
    public void canMakeANDCompoundQueryWithATextSearch() {
        assertThat(ds.ensureIndexed(Arrays.<Object>asList("name"), "basic"), is("basic"));
        assertThat(ds.ensureIndexed(Arrays.<Object>asList("name", "comment"), "basic_text", IndexType.TEXT),
                   is("basic_text"));
...
//        }
    ...
    public void canQueryUsingPorterTokenizerStemmer() {
        ...
        assertThat(ds.ensureIndexed(fields, "basic_text", IndexType.TEXT, indexSettings), is("basic_text"));
