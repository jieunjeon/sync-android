 ...
 */
public class NoSQLMatcherInovcationHandler implements InvocationHandler {


    private final Datastore datastore;
    private final Class<? extends Datastore> datastoreClazz;

    public NoSQLMatcherInovcationHandler(Datastore ds){
        datastore = ds;
    ...
    public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
        ...
        if(method.getName().equals("find")){
            ...
            MockMatcherQueryExecutor queryExecutor = new MockMatcherQueryExecutor(query.getDatabase(),
                    dsImpl,
                    query.getQueue());
